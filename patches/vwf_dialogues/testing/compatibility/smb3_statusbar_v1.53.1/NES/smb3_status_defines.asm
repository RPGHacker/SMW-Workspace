...
!StatusBarMAP = "smb3_status_map.bin"	;only used if !TilemapExGFX < $0080
!StatusBarGFX = "NES/smb3_status_gfx.bin"	;only used if !GraphicExGFX < $0080
!StatusBarPAL = "NES/smb3_status_pal.bin"
...
!TILE_big_top = $20	;start of top tiles
...
!world		= !row2+$06	;1 tile
!pmeter		= !row2+$08	;depends on !LEN_pmeter
!pmeter_icon	= !pmeter+$06	;depends on !SIZE_pmeter
!coins		= !row2+$12	;2 tiles
!bonus		= !row2+$1C	;2 tiles
!player		= !row3+$02	;depends on !SIZE_player
!lives		= !row3+$05	;2 tiles
!score		= !row3+$08	;6 tiles (final zero is not included)
!time		= !row3+$11	;3 tiles
!yicoins	= !row3+$17	;depends on !yicoins_max
!itembox	= !row2+$19	;see below for more info
...
!sprite0_YX = $C7C8	;this is the item box position (if enabled above)
!sprite0_PT = $0000
!sprite0_S = %1
!sprite1_YX = $F000
!sprite1_PT = $0000
