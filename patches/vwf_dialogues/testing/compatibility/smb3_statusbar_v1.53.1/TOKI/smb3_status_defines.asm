...
!Worlds = "TOKI/smb3_status_worlds.asm"
!StatusBarMAP = "TOKI/smb3_status_map.bin"	;only used if !TilemapExGFX < $0080
!StatusBarGFX = "TOKI/smb3_status_gfx.bin"	;only used if !GraphicExGFX < $0080
!StatusBarPAL = "TOKI/smb3_status_pal.bin"
...
!TILE_big_top = $10	;start of top tiles
...
!world		= !row3+$0F	;1 tile
!pmeter		= !row3+$12	;depends on !LEN_pmeter
!pmeter_icon	= 0		;depends on !SIZE_pmeter
!coins		= !row2+$13	;2 tiles
!bonus		= !row2+$1C	;2 tiles
!player		= !row2+$07	;depends on !SIZE_player
!lives		= !row2+$0A	;2 tiles
!score		= !row3+$06	;6 tiles (final zero is not included)
!time		= !row2+$17	;3 tiles
!yicoins	= 0		;depends on !yicoins_max
!itembox	= !row2+$02	;see below for more info
...
!sprite0_YX = $C714	;this is the item box position (if enabled above)
!sprite0_PT = $0000
!sprite0_S = %1
!sprite1_YX = $F000
!sprite1_PT = $0000
...
!EmptyTri	= $2E		;Empty tile of triangle
!EmptyPal	= $34
!FillTri	= $2F		;Filled tile of triangle
!FillPal	= $30
