...
"C:\Program Files\7-Zip\7z.exe" a ./%patchname%/%patchname%.zip %patchname%/README.md ../LICENSE %patchname%/blocks/ %patchname%/fonts/ %patchname%/%patchname%.asm %patchname%/vwfcode.asm %patchname%/vwfconfig.cfg %patchname%/vwffont1.asm %patchname%/vwffont1.bin %patchname%/vwffontpointers.asm %patchname%/vwfframes.asm %patchname%/vwfframes.bin %patchname%/vwfmessagepointers.asm %patchname%/messages/smw/vwfmessages.asm %patchname%/vwfpatterns.bin %patchname%/vwftable.txt %patchname%/scripts/generate_widths.py
