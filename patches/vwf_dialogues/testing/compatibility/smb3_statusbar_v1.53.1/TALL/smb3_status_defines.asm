...
!StatusBarMAP = "TALL/smb3_status_map.bin"	;only used if !TilemapExGFX < $0080
!StatusBarGFX = "TALL/smb3_status_gfx.bin"	;only used if !GraphicExGFX < $0080
!StatusBarPAL = "TALL/smb3_status_pal.bin"
...
!SIZE_time = 1
!SIZE_bonus = 1
!SIZE_yicoins = 1	;only if numeric yoshi coins are used, see further down
...
!world		= 0		;1 tile
!pmeter		= !row4+$01	;depends on !LEN_pmeter
!pmeter_icon	= !row4+$1D	;depends on !SIZE_pmeter
!coins		= !row2+$07	;2 tiles
!bonus		= !row2+$0B	;2 tiles
!player		= !row1+$01	;depends on !SIZE_player
!lives		= !row2+$03	;2 tiles
!score		= !row2+$17	;6 tiles (final zero is not included)
!time		= !row2+$13	;3 tiles
...
!EmptyTri	= $38		;Empty tile of triangle
!EmptyPal	= $28
!FillTri	= $38		;Filled tile of triangle
!FillPal	= $24
