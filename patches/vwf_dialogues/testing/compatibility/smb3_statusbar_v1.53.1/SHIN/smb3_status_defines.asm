...
!StatusBarMAP = "SHIN/smb3_status_map.bin"	;only used if !TilemapExGFX < $0080
!StatusBarGFX = "SHIN/smb3_status_gfx.bin"	;only used if !GraphicExGFX < $0080
!StatusBarPAL = "SHIN/smb3_status_pal.bin"
...
!coins		= !row3+$16	;2 tiles
!bonus		= !row3+$0C	;2 tiles
!player		= !row2+$19	;depends on !SIZE_player
!lives		= !row3+$1C	;2 tiles
!score		= !row2+$02	;6 tiles (final zero is not included)
!time		= !row3+$06	;3 tiles
!yicoins	= !row2+$14	;depends on !yicoins_max
