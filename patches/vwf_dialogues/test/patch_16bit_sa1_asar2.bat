...
.\..\..\..\tools\asar\asar2.exe --symbols=wla --symbols-path=".\patched_16bit_sa1.cpu.sym" -D"bitmode=BitMode.16Bit" -I".\..\data\tests" -I".\..\fonts\Terranigma (E)" .\..\vwf_dialogues.asm .\patched_16bit_sa1.smc
